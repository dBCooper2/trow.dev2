...
- Rewrite Intro
- Adding Articles and Projects
- Explain About Me (MDX Rendering with a PDF Fallback)
- Changing CSS
- Embedding content into MDX
- Adding your own details to the site

# MY TODOS:

- Change colors
- Add Your Articles and Projects
